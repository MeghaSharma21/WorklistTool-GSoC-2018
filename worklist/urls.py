...
urlpatterns = [
        ...
        url(r'^update-task-table/(?P<worklist_created_by>[\s\S]+)/(?P<worklist_name>[\s\S]+)$',
            views.update_task_table, name='update_task_table'),
        url(r'^$', views.homepage, name='homepage'),
        url(r'^homepage$', views.homepage, name='homepage'),
        url(r'^show-tasks/(?P<worklist_created_by>[\s\S]+)/(?P<worklist_name>[\s\S]+)?/$',
            views.search_task, name='show_tasks'),
